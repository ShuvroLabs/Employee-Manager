...
class GeofenceLoadAll extends GeofenceEvent {
...
class GeofenceAdd extends GeofenceEvent {
  final String companyId;
  final String name;
...
class GeofenceUpdate extends GeofenceEvent {
...
class GeofenceRemove extends GeofenceEvent {
...
class GeofenceRegisterAll extends GeofenceEvent {
  final String companyId;
...
class GeofenceUnregisterAll extends GeofenceEvent {}

/// Event when a geofence transition occurs
class GeofenceTransition extends GeofenceEvent {
...
class GeofenceController extends Bloc<GeofenceEvent, GeofenceState> {
  ...
  GeofenceController({
    ...
    _eventSubscription = _geofenceService.geofenceEvents.listen(
      ...
      } as void Function(GeofenceEvent)?,
    );
  }
